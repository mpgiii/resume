...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Systems/Software Engineer}{Jun. 2021 - Present}
      \resumeItemListStart
        \resumeItemSingle
          {Writing tests and refactoring code for a new daemon being produced by my team}
        \resumeItemSingle
          {Leading a newly-created Proto Support team to automate and simplify the engineering process when working with in-office hardware remotely}
        \resumeItemSingle
          {Debugging issues by working closely with other teams and determining root causes}
      \resumeItemListEnd
